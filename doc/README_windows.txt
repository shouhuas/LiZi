...
wallet directory. Grant access to LiZid.exe in anti-virus and firewall
...
LiZid backupwallet <destination_backup_file>
Then shutdown LiZid by
LiZid stop
Start up the new LiZid.
