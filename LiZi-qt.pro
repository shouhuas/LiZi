...
isEmpty(BDB_LIB_PATH) {
   ...
   windows:BDB_LIB_PATH = C:\lib\db-6.1.26\build_unix
}
...
isEmpty(BDB_INCLUDE_PATH) {
    ...
    windows:BDB_INCLUDE_PATH = C:\lib\db-6.1.26\build_unix
}

isEmpty(BOOST_LIB_PATH) {
    macx:BOOST_LIB_PATH = /opt/local/lib
    windows:BOOST_LIB_PATH = C:\boost\lib
}

isEmpty(BOOST_INCLUDE_PATH) {
    macx:BOOST_INCLUDE_PATH = /opt/local/include
    windows:BOOST_INCLUDE_PATH = C:\Boost\include\boost-1_59
}

isEmpty(OPENSSL_LIB_PATH) {
    windows:OPENSSL_LIB_PATH = C:\lib\openssl-OpenSSL_1_0_1g
}

isEmpty(OPENSSL_INCLUDE_PATH) {
    windows:OPENSSL_INCLUDE_PATH = C:\lib\openssl-OpenSSL_1_0_1g\include
}
