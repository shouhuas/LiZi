...
void StatisticsPage::updateStatistics()
{
    ...
    {
        ui->rewardBox->setText("<b><font color=\"red\">" + subsidy + " LiZi</font></b>");
    } else if(nSubsidy > rewardPrevious) {
        ui->rewardBox->setText("<b><font color=\"green\">" +  subsidy + " LiZi</font></b>");
    } else {
    ui->rewardBox->setText(subsidy+" LiZi");
    }
    ...
    {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " LiZi" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " LiZi" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " LiZi");
    }
    ...
    if (pindexBest->nHeight < 7200001)
    {
        ...
        ui->phaselbl1->setText(QString("<b>Block 2 -> 720000 : PoW (250 LiZi) & PoS</b><br/>Approximately %1 days remain." ).arg(daysLeft));

    }
    else
        ui->phaselbl1->setText("Block 2 -> 720000 : PoW (250 LiZi) & PoS");
    if (pindexBest->nHeight > 720000 && pindexBest->nHeight < 3875761)
    {
        int daysLeft =((3875760 - 720000) - (nHeight - 720000)) / (1440 * 2);
        ui->phaselbl2->setText(QString("<b>Block 7200001 -> 3875760 : PoW (10 LiZi)  & PoS</b><br/>Approximately %1 days remain." ).arg(daysLeft));
    }
    else
        ui->phaselbl2->setText("Block 7200001 -> 3875760 : PoW (10 LiZi)  & PoS");
    if (pindexBest->nHeight > 3875760 && pindexBest->nHeight < 4927681)
    {
        int daysLeft =((4927680 - 3875760) - (nHeight - 3875760)) / (1440 * 2);
        ui->phaselbl3->setText(QString("<b>Block 3875761 -> 4927680 : PoW (100 LiZi) & PoS</b><br/>Approximately %1 days remain." ).arg(daysLeft));
    }
    else
        ui->phaselbl3->setText("Block 3875761 -> 4927680 : PoW (100 LiZi) & PoS");
    if (pindexBest->nHeight > 4927680 && pindexBest->nHeight < 6519081)
    {
        int daysLeft =((6519080 - 4927680) - (nHeight - 4927681)) / (1440 * 2);
        ui->phaselbl4->setText(QString("<b>Block 4927681 -> 6519080 : PoW (10 LiZi)  & PoS</b><br/>Approximately %1 days remain." ).arg(daysLeft));
    }
    else
        ui->phaselbl4->setText("Block 4927681 -> 6519080 : PoW (10 LiZi)  & PoS");
    if (pindexBest->nHeight > 6519080)
